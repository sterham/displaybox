...
<body>
	...
	<nav class="navbar">
		<div class="navbar__logo">
			<img src="images/foruslogo.png" alt=""> <a href=""></a>
		</div>
					...
					<div class="card text-center card-product">
						...
						<div class="card-body">
							...
							<h4 class="card-product__title">
								<a href="single-product.html">손목 시계</a>
							</h4>
				...
				<div class="col-md-6 col-lg-4 col-xl-3">
					<div class="card text-center card-product">
						...
						<div class="card-body">
							<p>No.2</p>
							<h4 class="card-product__title">
								<a href="single-product.html">핸드크림</a>
							</h4>
				...
				<div class="col-md-6 col-lg-4 col-xl-3">
					<div class="card text-center card-product">
						...
						<div class="card-body">
							<p>No.3</p>
							<h4 class="card-product__title">
								<a href="single-product.html">조명</a>
							</h4>
				...
				<div class="col-md-6 col-lg-4 col-xl-3">
					<div class="card text-center card-product">
						...
						<div class="card-body">
							<p>No.4</p>
							<h4 class="card-product__title">
								<a href="single-product.html">향수</a>
							</h4>
